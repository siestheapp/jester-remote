"""
DEPRECATED: Original Jester Chat Vector implementation.

Deprecation Date: 2025-04-23
Reason: Refactored to improve modularity and separate concerns
New Implementation: 
- Chat functionality: app/core/jester_chat.py
- Vector search: app/core/vector_search.py

Migration Guide:
1. Use JesterChat class from app.core.jester_chat for chat functionality
2. Use JesterVectorSearch from app.core.vector_search for vector operations
3. Update any direct FAISS index references to use the new vector_search module
"""
